...
from .routes import (
    align, camera, capture_ekos, files, filter_wheel, focuser, guide, indi_panel,
    mount, observation, observatory, scheduler, setup, system,
)
...
def create_app() -> FastAPI:
    ...
    for r in (system.router, indi_panel.router, mount.router, camera.router,
              focuser.router, filter_wheel.router, guide.router,
